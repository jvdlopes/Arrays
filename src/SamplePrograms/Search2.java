...
public class Search2 extends javax.swing.JFrame {
    ...
    public static String[] search(String cat) {
        ...
        //splits result into an array using , to sepearate each time
        if (result.equals("")) {
            return new String[0];
        }
        return result.split(",");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(searchBox, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
